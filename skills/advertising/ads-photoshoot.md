...
**Output sizes:** 1080x1080, 1080x1920
...
**Output sizes:** 1080x1080 (optimal for this style)
...
For each style x size combination:
```bash
...
Product photos generated: [N] images
  ...
  Estimated cost: [N] images x $0.067 = ~$[total]
...
- "$[N] images x $0.067 = ~$[total] (Gemini default)"
